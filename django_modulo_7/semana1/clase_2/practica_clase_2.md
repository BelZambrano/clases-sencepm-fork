...
Debes implementar los siguientes 15 modelos. Cada uno vive en su propio archivo. La descripción es intencional: el código lo escribes tú, no se entrega el modelo hecho.
