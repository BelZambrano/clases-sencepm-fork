...
| `requirements.txt` | Lista de todas las librerías que el proyecto necesita para funcionar, con sus versiones exactas.                          | Al compartir el proyecto o desplegarlo en producción: `pip install -r requirements.txt` |
