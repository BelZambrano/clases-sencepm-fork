...
# Validar si existe y solicitar el campo
if cliente_encontrado:
    print(f"Cliente encontrado: {cliente_encontrado['nombre_completo']}")
    print("Campos disponibles: nombre_completo, correo, telefono, estado")
    
    campo = input("¿Qué campo desea editar?: ")
