...
id_buscar = input("Ingrese el ID del cliente: ").strip()
campo = input("Seleccione el campo a modificar (1-4): ").strip()
...
for cliente in clients:
    if str(cliente["id"]) == id_buscar:
        ...
        match campo:
            case "1":
                nuevo = input("Nuevo nombre completo: ")
                cliente["nombre_completo"] = nuevo
