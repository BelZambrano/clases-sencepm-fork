...
try:
    id = int(input("Ingrese el ID del cliente que desea buscar:\n "))
except ValueError:
...
if encontrado == True: 
    try:
        cambio_nombre = input("Ingrese el nuevo nombre completo del cliente:\n ")
        for cliente in clients:
            if cliente["id"] == id and cambio_nombre != "":
                cliente["nombre_completo"] = cambio_nombre
