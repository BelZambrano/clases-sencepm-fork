...
potenciales = (potenciales / todos) * 100
altointeres = (altointeres / todos) * 100
procesocomprra = (procesocompra / todos) * 100
clienteefectivo = (clienteefectivo / todos) * 100
supercliente = (supercliente / todos) * 100

print(f"El porcentaje de clientes potenciales es: {potenciales}%\n")
print(f"El porcentaje de clientes de alto interes es: {altointeres}%\n")
print(f"El porcentaje de clientes en proceso de compra es: {procesocompra}%\n")
print(f"El porcentaje de clientes efectivos es: {clienteefectivo}%\n")
print(f"El porcentaje de super clientes es: {supercliente}%\n")