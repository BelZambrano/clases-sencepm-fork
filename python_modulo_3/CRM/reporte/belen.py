...
if total == 0:
    print("No hay clientes para reportar.")
else:
    print(
        "Total de personas:", total, "\n\n"
        "Clientes potenciales:", potencial, "-", round(potencial * 100 / total, 1), "%\n"
        "Alto interés:", alto, "-", round(alto * 100 / total, 1), "%\n"
        "En proceso de compra:", proceso, "-", round(proceso * 100 / total, 1), "%\n"
        "Clientes efectivos:", efectivo, "-", round(efectivo * 100 / total, 1), "%\n"
        "Super cliente:", superc, "-", round(superc * 100 / total, 1), "%\n"
    ) 
