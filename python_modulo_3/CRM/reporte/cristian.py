...
match opcion:
    case "1":
        ...
        if total > 0:
            print(f"\nCliente potencial: {potencial} ({potencial/total*100:.2f}%)")
            print(f"Alto interés: {alto_interes} ({alto_interes/total*100:.2f}%)")
            print(f"En proceso de compra: {en_proceso} ({en_proceso/total*100:.2f}%)")
            print(f"Cliente efectivo: {efectivo} ({efectivo/total*100:.2f}%)")
            print(f"Super cliente: {super_cliente} ({super_cliente/total*100:.2f}%)")
        else:
