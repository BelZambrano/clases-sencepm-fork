...
entrada = input("Ingresa el ID del cliente a eliminar: ")
...
if entrada.isdigit():
    ...
    for c in clients:
        if c["id"] == id_eliminar:
            clientes_eliminados.append(c)  # Mover a eliminados
            clients.remove(c)              # Remover de la lista original
...
print("Clientes eliminados:", clientes_eliminados)